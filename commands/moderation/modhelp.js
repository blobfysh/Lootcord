...
module.exports = {
    ...
    execute(message, args, lang, prefix){
        const modCommands = [
            ...
            "`" + prefix + "silentban <id> <reason>` - Bans user without message.",
            "`" + prefix + "tradeban <id> <reason>` - Bans user from trading or using clan vaults.",
            "`" + prefix + "unban <id>` - Unbans user and sends them message stating they've been unbanned.",
            "`" + prefix + "untradeban <id>` - Removes trade ban from a user and sends them a message.",
