module.exports = {
	...
	execute(app, message, { args, prefix }) {
        ...
        3. **Do not leave servers you have just activated in to avoid the deactivate cooldown.** This is known as cooldown dodging, and is automatically reported to moderators on offense.\n
